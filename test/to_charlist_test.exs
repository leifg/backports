defmodule ToCharlistTest do
  ...
  test "ToCharlistWrapper returns correct charlist" do
    assert ToCharlistWrapper.to_charlist("abcde") == 'abcde'
  end

  test "ToCharlistWrapper returns correct charlist tuple (2 elements)" do
    assert ToCharlistWrapper.to_charlist_tuple_2("abcde") == {'abcde', 'abcde'}
  end

  test "ToCharlistWrapper returns correct charlist tuple (2 with array)" do
    assert ToCharlistWrapper.to_charlist_tuple_2_with_array("abcde") == {'abcde', ["a", "b"]}
  end

  test "ToCharlistWrapper returns correct charlist tuple (3 elements)" do
